...
export default function About() {
  ...
  return (
    <main className="min-h-screen bg-[#0A1628] text-[#E6EEF7]" id="about">
      {/* =====================================================
          HERO
      ====================================================== */}
        ...
        <div className="relative mx-auto grid min-h-[720px] max-w-7xl items-center gap-16 px-6 py-24 lg:grid-cols-[1.15fr_0.85fr] lg:px-8">
          ...
          <div>
            ...
            <h1 className="max-w-4xl text-5xl font-bold leading-[0.95] tracking-[-0.04em] sm:text-6xl lg:text-8xl">
              Email security,
              <br />
              <span className="text-[#22D3EE]">built for investigation.</span>
            </h1>

            <p className="mt-8 max-w-2xl text-base leading-8 text-[#8FA9C4] sm:text-lg">
              MAILTRACE is an evidence-first email threat investigation platform
              designed to turn a raw email into structured, explainable and
            ...
            <div className="mt-12 flex flex-wrap gap-8">
              <div className="border-l border-[#22456E] pl-4">
                ...
                <p className="mt-1 text-sm font-medium">SIH26106</p>
              </div>
              ...
              <div className="border-l border-[#22456E] pl-4">
                ...
                <p className="mt-1 text-sm font-medium">Cybersecurity</p>
              </div>
              ...
              <div className="border-l border-[#22456E] pl-4">
                ...
                <p className="mt-1 text-sm font-medium">05 Members</p>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-28 lg:px-8">
          <div className="mb-14">
            ...
            <h2 className="mt-4 max-w-4xl text-4xl font-bold leading-tight tracking-tight sm:text-5xl lg:text-6xl">
              ...
              <br />
              <span className="text-[#22D3EE]">to one investigation.</span>
            </h2>
          </div>
          ...
          <div className="grid gap-10 lg:grid-cols-2">
            <div className="space-y-6 text-sm leading-8 text-[#8FA9C4] sm:text-base">
              <p>
                Investigating a suspicious email often requires analysts to move
                between multiple tools for headers, authentication, threat
                intelligence, infrastructure analysis and reporting.
              </p>

              <p>
                MAILTRACE brings these investigation steps together into one
                evidence-first workflow, allowing analysts to move from the
                original message to a defensible conclusion.
              </p>

              <p>
                Every important finding should be traceable back to evidence.
              </p>
            </div>
            ...
            {capabilities.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="mt-20 text-xl font-semibold">{item.title}</h3>
        ...
        <div className="mx-auto max-w-7xl px-6 py-28 lg:px-8">
          <div className="mb-16">
            ...
            <h2 className="mt-4 text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
              Follow the evidence,
              <br />
              <span className="text-[#22D3EE]">not assumptions.</span>
            </h2>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-28 lg:px-8">
          <div className="mb-14">
            ...
            <h2 className="mt-4 text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
              Engineered for
              <br />
              <span className="text-[#22D3EE]">speed and explainability.</span>
            </h2>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-28 lg:px-8">
          <div className="mb-14">
            ...
            <p className="mt-6 max-w-2xl text-sm leading-7 text-[#8FA9C4]">
              A focused engineering team covering digital forensics, AI/ML,
              threat intelligence, backend engineering and frontend/DevOps.
            </p>
          </div>
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
            {team.map((member) => (
              ...
              >
                ...
                <h3 className="mt-3 text-lg font-semibold">{member.title}</h3>
        ...
        <div className="mx-auto grid max-w-7xl gap-16 px-6 py-28 lg:grid-cols-2 lg:px-8">
          <div>
            ...
            <h2 className="mt-6 text-5xl font-bold leading-none tracking-tight sm:text-6xl lg:text-7xl">
              ...
              infrastructure,
              <br />
              <span className="text-[#22D3EE]">not people.</span>
            </h2>
          </div>
          ...
          <div>
            ...
            <p className="max-w-xl text-sm leading-8 text-[#8FA9C4] sm:text-base">
              MAILTRACE does not claim to identify an attacker or their physical
              location. It reports the earliest reliable observable
              infrastructure, its network context and the confidence behind that
              finding.
            </p>
            ...
            <div className="mt-8 border border-[#22456E] p-5">
              ...
              <p className="mt-3 pl-5 text-xs leading-6 text-[#8FA9C4]">
                When evidence is insufficient, the platform says so. Explicit
                uncertainty is better than unsupported attribution.
              </p>
            </div>
          </div>
        </div>
